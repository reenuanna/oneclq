...
<tr>
                                    ...
                                    <tr style="background-color: whitesmoke">
                                        <td style="color: deeppink" bgcolor="lightgoldenrodyellow" >
                                            {{$value->name}}</td>
                                        <td style="color: red">{{$value->date}}  <br/>
                                            <?php
                                        ...
                                        <td><a href="/deleteacc/{{$value->id}}" class="btn btn-danger">delete</a></td>
                                        <?php
                                        }
                                        ?>
                                        {{--<td><a href="/deactivate/{{$value->id}}" class="button">Deactivate</a> </td>--}}
