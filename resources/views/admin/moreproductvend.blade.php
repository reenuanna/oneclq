                ...
                <div class="col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table  class="table">
                                {{--<p><tr ><td  style="color:#d91a72" colspan="7" align="center">Description</td></tr></p>--}}
                                <tr style="color:#d91a72">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table  class="table">
                            ...
                            <tr >
                                {{--<td colspan="7" style="color:#d91a72" align="center">Details</td></tr>--}}
                                <td><a href="/approveprodvend/{{$value->prod_id}}" class="btn btn-primary"> Approve</a></td>


                                <form method="post" action="/disapproveprodvend/{{$value->prod_id}}">
                                    @csrf
