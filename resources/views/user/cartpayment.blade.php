                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 offset-3 col-md-offset-6">
                                                        ...
                                                        <form name="frm" method="post" action="/cod">
                                                            ...
                                                            <input type="hidden" name="buyid" value="{{$value->buyid}}">
                                                            <input type="hidden" name="prod_id" value="{{$value->prod_id}}">
                                                            <input type="hidden" name="amount" value="{{$cart}}">
                                                                ...
                                                                <div class="card card-default">
                                                                    ...
                                                                    <div class="card-body text-center">
                                                                        <form action="{{ route('razorpay.payment.cartstore') }}" method="POST" >
                                                                            ...
                                                                            <input type="hidden" name="buyid" value="{{$value->buyid}}">
                                                                            <input type="hidden" name="prod_id" value="{{$value->prod_id}}">
                                                                            <input type="hidden" name="amount" value="{{$value->total}}">
                                                                            @endforeach
                                                                            @foreach($cart as $sm)
                                                                            ...
                                                                            <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                                                    ...
                                                                                    data-currency="INR"
                                                                                    data-buttontext="Pay {{$sm->csum}} INR"
                                                                                    data-name="onecliq"
