...
<p>
                <b >Sign Up</b>
                <p>Create your seller account.</p></div></p>
            <div class="login">
                <form method="post" action="/store">
                    ...
                    <input type="text" class="form-control" value="91" id="mobile" placeholder="Enter your Mobile Number" name="mobile">
                    </div>
                    @error("mobile")
                ...
                <b>Already a member ? </b><a href="/vendor">Signin</a>
            </div>
        </div>
    </div>
</div>
<script>
    $(document).ready(function(){
        $("#otp").click(function(){
                if($('#mobile').val() != "" && ($('#mobile').val().length == 12 ) ) {
